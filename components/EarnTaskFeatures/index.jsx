...
export default function EarnTaskFeatures() {
  ...
  return (
    <div className="space-y-12">
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-10">
            <h2 className="text-3xl lg:text-4xl font-serif font-extrabold text-teal-700 mb-3">
              Why Choose EarnTask?
            </h2>
          ...
          >
            {features.map((f, idx) => (
              <motion.div key={f.id} variants={item} className="break-inside-avoid">
                <Card
                  className={`relative overflow-hidden transform transition-all duration-300 hover:scale-[1.02] hover:shadow-2xl group border-0`}
                ...
                >
                  ...
                  <CardHeader className="relative p-6">
                    <div className="flex items-start gap-4">
                      <div
                        className="flex-shrink-0 w-14 h-14 rounded-xl bg-white/60 backdrop-blur-sm border border-white/40 flex items-center justify-center shadow-sm group-hover:scale-105 transform transition"
                        aria-hidden
                      >
                    ...
                    <div className="mt-4 flex items-center justify-between">
                      ...
                      <div className="text-xs font-medium text-teal-700">Trusted</div>
                    </div>
                  </CardHeader>
                </Card>
              </motion.div>
      ...
      {/* CTA Section */}
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-teal-50 to-white/60">
        <div className="max-w-4xl mx-auto text-center">
          <motion.h2
            initial={{ opacity: 0, y: 8 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.5 }}
            className="text-3xl lg:text-4xl font-serif font-extrabold mb-4 text-teal-800"
          >
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button
              asChild
              size="lg"
              className="bg-teal-600 hover:bg-teal-700 text-white px-8 py-3 text-lg rounded-full shadow-lg transform transition-all"
            >
            ...
            <Button
              ...
              variant="outline"
              size="lg"
              className="text-lg px-8 py-3 rounded-full bg-transparent border border-teal-200 hover:border-teal-300"
            >
          ...
          <div className="mt-6 flex items-center justify-center gap-6 text-sm text-muted-foreground">
            <div className="flex items-center gap-2">
              <div className="w-8 h-8 rounded-full bg-white/80 flex items-center justify-center shadow">✓</div>
