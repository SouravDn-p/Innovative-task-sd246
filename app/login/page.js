      ...
      <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md relative z-10">
        <Card className="bg-white/5 backdrop-blur-xl border-white/10 shadow-2xl hover:shadow-sky-500/10 transition-all duration-300">
          <CardHeader className="text-center">
            <CardTitle className="bg-gradient-to-r from-white to-gray-300 bg-clip-text text-transparent text-2xl">
              Sign In
            </CardTitle>
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <Input
                    ...
                    className={`pl-11 bg-white/5 border-white/20 text-white placeholder:text-gray-400 focus:border-sky-400 focus:ring-sky-400/20 ${
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <Input
                    ...
                    onChange={handleChange}
                    className={`pl-11 pr-11 bg-white/5 border-white/20 text-white placeholder:text-gray-400 focus:border-sky-400 focus:ring-sky-400/20 ${
