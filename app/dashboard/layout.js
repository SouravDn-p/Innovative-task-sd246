...
export default function DashboardLayout({ children }) {
  ...
  const role = useSelector((state) => state.auth.role) || "user"; // Fallback to "user" if role is undefined
  const userNavigation = navigation[role] || navigation.user; // Fallback to user navigation
